	...
	<body>
		<div class="row">
			<div class="panel panel-small span12"
				style="margin-left: 50px; margin-top: 20px; width: 1000px;">
							...
							<div id="content" class="hidden">
								...
								<div style="margin-bottom: 50px;"> 
							     	<div style="float: left;">
								      	<img width="60px;" height="60px;" src="${path}/${warning.applicant.image}">
								    </div>
									<div style="margin-left: 70px;margin-top: 10px;"> 
									     <div>
									     	<div style="float: left;color: #9F9F9F"> 
										      ${warning.applicant.username}
										     </div>
									     ...
									     <div style="margin-top: 10px;">
									     	...
									     	<a class="page-action" href="#" data-href="${path}/warn/selectone.do?id=${warning.id}" title="报障信息" data-id="${warning.id}">
									     		<span style="color: #08c;font-weight: bold;">${warning.title}</span>
									     	</a>
									     </div>
									     <div style="text-align: left;margin-top:10px;color: #9F9F9F;max-width: 800px;min-height: 20px;">
...
<script type="text/javascript">
    ...
    $.jqPaginator('#pagination1', {
        ...
        onPageChange: function (num, type) {
        	if(type!='init'){
        		location.href="${path}/warn/warnList.do?num="+num;
        	}
        }
    });
