...
<form id="J_Form" class="form-horizontal" method="post" action="">
		...
		<div class="control-group"> 
			...
			<div class="control-group">
              ...
              <div class="controls">
                <select id="parentId" name="parentId" data-rules="{required:true}">
			...
			<div class="search-grid-container">
				<div style="margin-left: 30px;margin-top: 10px;"><h3>部门列表</h3></div>
...
<script type="text/javascript">
    ...
    BUI.use(['bui/grid','bui/data'],function(Grid,Data){
	    ...
	    columns = [
		    ...
		    { title: '部门名称', width: 30, sortable: false, dataIndex: 'name', selectable: true },
		    { title: '上级部门', width: 30, sortable: false, dataIndex: 'parent', selectable: true,renderer:function(value){
		    		if(value!=null){
		    			return value.name;
		    		}else{
		    			return "没有上级";
      ...
      if(selections.length==1){
         BUI.use(['bui/overlay','bui/form'],function(Overlay,Form){
		    var dialog = new Overlay.Dialog({
			    ...
			    success:function () {
				    $("#J_Form").attr("action","${path}/department/updateDepartment.do");
					$("#J_Form").submit();
			    }
		    });
